...
helpsImage = pygame.image.load(os.path.join('assets', 'graphics', 'help.png'))
...
ENEMY_LASER_SOUND = pygame.mixer.Sound(os.path.join('assets', 'sounds', 'spaceship_bullet.wav'))
...
backgroundImage = pygame.image.load(os.path.join('assets', 'graphics', 'stage1.png'))
